...
const StillConfused = () => {
  return (
    <div className="py-12 mt-16 bg-gradient-to-r from-purple-100 to bg-purple-50">
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full sm:w-2/3 text-center sm:text-left">
            ...
            <div className="text-left text-gray-700 mb-6">
              <ul className="list-disc pl-5">
                ...
                <li className="mb-2">Clarify any confusion about taxes, finance, or compliance.</li>
                <li className="mb-2">Access to industry-leading experts with years of experience.</li>
              </ul>
            </div>
            ...
            <div className="p-6 transition-all duration-300 mb-6 animate__animated animate__fadeInUp animate__delay-2s">
              ...
              <button className="bg-purple-600 hover:bg-purple-500 text-white py-2 px-6 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 -mx-4">
                Book Your Call
              </button>
            </div>
          </div>
          ...
          {/* <a href="https://www.freepik.com/search">Icon by Sumitsaengtong</a> */}
            <img src="talk.jpg" alt="Consultation Illustration" className="w-full h-auto transform hover:scale-105 transition-all duration-300" />
          </div>
        </div>
        ...
        <div className="sm:hidden mt-8 text-center">
          ...
          <img src="talk.jpg" alt="Consultation Illustration" className="w-72 h-auto mx-auto mb-6 transform hover:scale-105 transition-all duration-300" />
        </div>
      </div>
    </div>
  );
