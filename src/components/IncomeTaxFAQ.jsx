...
const TaxFAQ = () => {
  ...
  const sections = {
    income: {
      title: "Income Tax",
      icon: <Landmark className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" />,
      questions: [
        {
          id: 'what-is-tax',
        ...
        },
        {
          ...
          icon: <Wallet className="w-4 h-4 sm:w-5 sm:h-5 text-green-500" />
        },
        {
          id: 'due-dates',
    ...
    taxSaving: {
      ...
      questions: [
        ...
        },
        {
          ...
          icon: <BrainCircuit className="w-4 h-4 sm:w-5 sm:h-5 text-orange-500" />
        }
      ]
    },
    business: {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-lg">
      ...
      <div className="p-2 sm:p-6 ">
        ...
        <div className="flex overflow-x-auto pb-2 mb-4 sm:mb-6 sm:flex-wrap sm:justify-center no-scrollbar justify-evenly lg:gap-4">
